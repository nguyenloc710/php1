...
<a href="userlist.php">Danh sách người dùng</a>
    ...
    <div class="content">
    <h1>Products</h1>
    <h3><a href="productadd.php">Thêm sản phẩm</a></h3> 
    ...
    <tr>
        ...
        <tr>
            ...
            <td></td>
            <td>
                <a href="productedit.php?editid=<?php echo $row['productId']?>">Sửa</a>|
                <a onclick="return confirm('Bạn có muốn xóa sản phẩm này');" href="?delid=<?php echo $row['productId'];?>">Xóa</a>
            </td>
        </tr>
        <?php
            }
